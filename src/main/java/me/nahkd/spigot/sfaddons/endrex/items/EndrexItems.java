...
public class EndrexItems {
	...
	public static void init(Endrex plugin) {
		// Resources
		CATEGORY_RESOURCES = new ItemGroup(new NamespacedKey(plugin, "resources"), new CustomItemStack(PlayerHead.getItemStack(EndrexSkulls.PEARL_ORE), "&e末地科技 &7- &b资源"));
		initResources(plugin);
		
		// Machines
		CATEGORY_MACHINES = new ItemGroup(new NamespacedKey(plugin, "machines"), new CustomItemStack(PlayerHead.getItemStack(EndrexSkulls.ENHANCED_CRUCIBLE_EMPTY), "&e末地科技 &7- &b基础机器"));
		initCrucibles(plugin);
		initDustsFarbicators(plugin);
		
		// Weapons
		CATEGORY_WEAPONS_AND_EQUIPMENTS = new ItemGroup(new NamespacedKey(plugin, "weapons_n_equipments"), new CustomItemStack(Material.DIAMOND_SWORD, "&e末地科技 &7- &b武器和护甲"));
		initWeapons(plugin);
		initEquipments(plugin);
		
		CATEGORY_MISCELLANEOUS = new ItemGroup(new NamespacedKey(plugin, "miscellaneous"), new CustomItemStack(Material.ENDER_EYE, "&e末地科技 &7- &b杂项"));
	...
	private static void initResources(Endrex plugin) {
		...
		REINFORCED_DRAGON_SCALE = new EndrexItem(CATEGORY_RESOURCES, (SlimefunItemStack) new ItemStackWrapper(new SlimefunItemStack("REINFORCED_DRAGON_SCALE", Material.BLACK_DYE, "&e强化龙鳞", "", "&7更难获取了...")).addEnchant(Enchantment.UNBREAKING, 0).addFlag(ItemFlag.HIDE_ENCHANTS).getItem(), RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
	...
	private static void initWeapons(Endrex plugin) {
		...
		MYSTERIOUS_SWORD = new MysteriousEquipment(CATEGORY_WEAPONS_AND_EQUIPMENTS, new SlimefunItemStack(
				...
				// Spagetti code
				new RandomEnchantmentEntry(Enchantment.UNBREAKING, 0.20, 1, 1),
				new RandomEnchantmentEntry(Enchantment.UNBREAKING, 0.12, 2, 4),
				new RandomEnchantmentEntry(Enchantment.UNBREAKING, 0.05, 5, 6),
				new RandomEnchantmentEntry(Enchantment.SHARPNESS, 0.08, 1, 2),
				new RandomEnchantmentEntry(Enchantment.SHARPNESS, 0.05, 3, 3),
				new RandomEnchantmentEntry(Enchantment.SHARPNESS, 0.02, 4, 6),
				new RandomEnchantmentEntry(Enchantment.SMITE, 0.03, 1, 2),
				new RandomEnchantmentEntry(Enchantment.BANE_OF_ARTHROPODS, 0.03, 1, 2),
		...
		MYSTERIOUS_PICKAXE = new MysteriousEquipment(CATEGORY_WEAPONS_AND_EQUIPMENTS, new SlimefunItemStack(
				...
				new RandomEnchantmentEntry(Enchantment.UNBREAKING, 0.12, 2, 4),
				new RandomEnchantmentEntry(Enchantment.UNBREAKING, 0.05, 5, 6),
				new RandomEnchantmentEntry(Enchantment.EFFICIENCY, 0.15, 1, 2),
				new RandomEnchantmentEntry(Enchantment.EFFICIENCY, 0.09, 3, 5),
				new RandomEnchantmentEntry(Enchantment.EFFICIENCY, 0.06, 6, 8),
				new RandomEnchantmentEntry(Enchantment.FORTUNE, 0.10, 1, 1),
				new RandomEnchantmentEntry(Enchantment.FORTUNE, 0.07, 2, 4),
				new RandomEnchantmentEntry(Enchantment.FORTUNE, 0.03, 5, 6),
	...
	private static void initEquipments(Endrex plugin) {
		ELYTRA_OF_THE_LITTLE_DRAGON = new EndrexEquipment(CATEGORY_WEAPONS_AND_EQUIPMENTS, (SlimefunItemStack) new ItemStackWrapper(new SlimefunItemStack("ELYTRA_OF_THE_LITTLE_DRAGON", Material.ELYTRA, "&e小龙的鞘翅", "", "&7它真的还没长大...")).addEnchant(Enchantment.UNBREAKING, 2).getItem(), RecipeType.ANCIENT_ALTAR, new ItemStack[] {
		...
		REINFORCED_ELYTRA = new EndrexEquipment(CATEGORY_WEAPONS_AND_EQUIPMENTS, (SlimefunItemStack) new ItemStackWrapper(new SlimefunItemStack("REINFORCED_ELYTRA", Material.ELYTRA, "&e增强型鞘翅")).addEnchant(Enchantment.UNBREAKING, 5).getItem(), RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
